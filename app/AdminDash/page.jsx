      ...
      <div className='block w-screen '>
                  ...
                  >
                    <div className="absolute left-full top-0 flex w-16 justify-center pt-5">
                      <button type="button" className="-m-2.5 p-2.5" onClick={() => setSidebarOpen(false)}>
                        ...
                        <XMarkIcon className="h-6 w-6 text-grey" aria-hidden="true" />
                      </button>
                    </div>
                  </Transition.Child>
                  {/* Sidebar component, swap this element with another sidebar if you like */}
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 ring-1 ring-grey/10">
                    ...
                    <nav className="flex flex-1 flex-col">
                      <ul role="list" className="flex flex-1 flex-col gap-y-7 ">
                               ...
                               <Link
                                  ...
                                  className={classNames(
                                    item.current
                                      ...
                                      : 'text-gray-400 hover:text-grey hover:bg-gray-800',
                          ...
                          <ul role="list" className="-mx-2 mt-2 space-y-1">
                            {teams.map((team) => (
                              <li key={team.name}>
                                ...
                                >
                                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-gray-700 bg-gray-800 text-[0.625rem] font-medium text-gray-400 group-hover:text-grey">
                                    {team.initial}
                                  </span>
                        ...
                        <li className="-mx-6 mt-auto">
                          <a
                            href="#"
                            className="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-grey hover:bg-gray-800"
                          >
                            <img
        ...
        <div className="xl:pl-72">
          ...
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-grey/5 bg-gray-800 px-4 shadow-sm sm:px-6 lg:px-8">
            <button type="button" className="-m-2.5 p-2.5 text-grey xl:hidden" onClick={() => setSidebarOpen(true)}>
          ...
          <div className=''>
                ...
                {stats.map((stat, statIdx) => (
                  ...
                  >
                    ...
                    <p className="mt-2 flex items-baseline gap-x-2">
                      <span className="text-4xl font-semibold tracking-tight text-grey">{stat.value}</span>
            ...
            <div className="border-t border-grey/10 pt-11">
              <h2 className="px-4 text-base font-semibold leading-7 text-grey sm:px-6 lg:px-8">Latest activity</h2>
                    ...
                    <tr key={item.commit}>
                      <td className="py-4 pl-4 pr-8 sm:pl-6 lg:pl-8">
                        <div className="flex items-center gap-x-4">
                          ...
                          <div className="truncate text-sm font-medium leading-6 text-grey">{item.user.name}</div>
                        </div>
                      </td>
                      ...
                      <td className="py-4 pl-0 pr-4 text-sm leading-6 sm:pr-8 lg:pr-20">
                        <div className="flex items-center justify-end gap-x-2 sm:justify-start">
                          ...
                          <div className="hidden text-grey sm:block">{item.status}</div>
                        </div>
                      </td>
